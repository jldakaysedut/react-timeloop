...
export default function VaultForm() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      // Load Local Storage Draft if new
      if (!editId) {
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        ...
        /* ── ROOT ── */
        .root{display:flex;width:100%;padding:16px;gap:12px}
        ...
        <div className="r-panel" style={{ background: rPanelGrad }}>
          <div className="rp-inner">
            ...
            <div className="rp-stat-row">
              ...
              <div className="rp-mini-stat"><span className="rp-mini-val">0</span><span className="rp-mini-lbl">Files</span></div>
            </div>
